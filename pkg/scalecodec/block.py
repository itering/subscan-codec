...
from pkg.scalecodec.base import ScaleDecoder, ScaleBytes
from pkg.scalecodec.metadata import MetadataDecoder
from pkg.scalecodec.types import Vec, CompactU32, Enum, Bytes, Struct, VecU8Length4
...
class PreRuntime(Struct):
    ...
    type_mapping = (('engine', 'u32'), ('data', 'HexBytes'))
